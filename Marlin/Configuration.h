...
#define STRING_CONFIG_H_AUTHOR "swordfish6975" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_MAX_RADIUS       97.0    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 218.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 355.00             // (mm) Get this value from G33 auto calibrate
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -16.60 }
